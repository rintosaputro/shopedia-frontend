          ...
          <Row className="align-items-center">
            <Col lg={8}>
              ...
              <div className="mt-5 mb-5 d-flex align-items-center">
                <div className={homepage.lineHorizontal} />
        ...
        <Container>
          ...
          <>
            <Row className="mt-5 mb-5 text-center">
              {data?.map((data) => (
                <Col style={{ cursor: 'pointer' }} onClick={() => route.push(`/product/${data.id}`)} key={data.id} md={4} className="mb-4">
        ...
        <Container>
          <div className={`${homepage.sectionTestimonial} text-center`}>
            ...
            <div className="d-flex justify-content-center mt-3">
              <div className={`${homepage.lineVertical} d-none d-md-block`} />
            </div>
            <div className={`${homepage.textTestimonial} text-color1 mt-4 text-center`}>
              ...
              If I could give multiple reasons for my rating it would also be for the design quality and customization to go along with the great service. The theme is excellent, keep up the great work.“
            </div>
