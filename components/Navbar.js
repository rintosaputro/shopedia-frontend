      ...
      <div className={`container ${styles.layout}`}>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <button type="button" className="btn position-relative ms-lg-1" onClick={() => route.push('/wishlist')}>
            ...
            <li className="nav-item">
              <button type="button" className="btn position-relative mx-lg-1" onClick={handleAddtoCart}>
            ...
            <li className="nav-item">
              <Dropdown>
                ...
                {token
                    && (
                    <Dropdown.Menu>
                      <Dropdown.Item onClick={() => route.push('/profile')}>
                        Profile
                      </Dropdown.Item>
                      {user.dataUser.role?.id !== 2 && (
                      <Dropdown.Item onClick={() => route.push('/my-store')}>
                        My Store
                      </Dropdown.Item>
                      )}
                ...
                {!token
                    && (
                    <Dropdown.Menu>
                      <Dropdown.Item onClick={() => route.push('/login')}>
                        Login
                      </Dropdown.Item>
                      <Dropdown.Item onClick={() => route.push('/signup')}>
                        Signup
                      </Dropdown.Item>
                    </Dropdown.Menu>
                    )}
